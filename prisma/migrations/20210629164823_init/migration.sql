...
-- AddForeignKey
ALTER TABLE `RequestForInformation` ADD FOREIGN KEY (`CreatedBy`) REFERENCES `User`(`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `StatusReportImage` ADD FOREIGN KEY (`CodeReportId`) REFERENCES `CodeReport`(`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
